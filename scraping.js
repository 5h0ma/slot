...
async function readMachineData(url) {
  ...
  let list = $('tbody', '#all_data_table');
  console.log(list[0].children);
  // list = list.match(/>.*?</g);
}

(async () => {
  const url = 'https://ana-slo.com/2022-12-27-%e3%82%a2%e3%82%a4%e3%83%a9%e3%83%b3%e3%83%89%e7%a7%8b%e8%91%89%e5%8e%9f%e5%ba%97-data/#section8';
  const html = await readMachineData(url);
  // console.log(html);
})();
...
//   const documents = [{ name: 'akiko', age: 19 }];
